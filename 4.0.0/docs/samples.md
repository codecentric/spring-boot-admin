...
* **[Servlet Sample](/4.0.0/docs/samples/sample-servlet.md)** - Traditional servlet-based deployment with security
* **[Reactive Sample](/4.0.0/docs/samples/sample-reactive.md)** - WebFlux reactive deployment

### Service Discovery[​](#service-discovery "Direct link to Service Discovery")

* **[Eureka Sample](/4.0.0/docs/samples/sample-eureka.md)** - Netflix Eureka integration
* **[Consul Sample](/4.0.0/docs/samples/sample-consul.md)** - HashiCorp Consul integration
* **[Zookeeper Sample](/4.0.0/docs/samples/sample-zookeeper.md)** - Apache Zookeeper integration

### Advanced[​](#advanced "Direct link to Advanced")

* **[Hazelcast Sample](/4.0.0/docs/samples/sample-hazelcast.md)** - Clustered deployment with Hazelcast
* **[Custom UI Sample](/4.0.0/docs/samples/sample-custom-ui.md)** - Custom UI extensions and branding
...
* [Getting Started](/4.0.0/docs/02-getting-started/) - Basic setup guide
* [Server Configuration](/4.0.0/docs/server/server.md) - Server configuration options
* [Integration](/4.0.0/docs/04-integration/) - Service discovery integration
* [Customization](/4.0.0/docs/06-customization/) - UI and server customization
