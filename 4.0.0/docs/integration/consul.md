...
* [Service Discovery](/4.0.0/docs/client/service-discovery.md) - Service discovery overview
* [Consul Sample](/4.0.0/docs/samples/sample-consul.md) - Detailed sample walkthrough
