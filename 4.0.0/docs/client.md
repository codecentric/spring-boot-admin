...
## [<!-- -->Features](/4.0.0/docs/client/client-features.md)

[Show Version in Application List](/4.0.0/docs/client/client-features.md)

## [<!-- -->Application Registration](/4.0.0/docs/client/registration.md)

[The Spring Boot Admin Client handles the registration of your application with the Admin Server through the](/4.0.0/docs/client/registration.md)

## [<!-- -->Metadata and Tags](/4.0.0/docs/client/metadata.md)

[Metadata allows you to attach custom information to your application registration, which can be used for filtering,](/4.0.0/docs/client/metadata.md)

## [<!-- -->Service Discovery Integration](/4.0.0/docs/client/service-discovery.md)

[Spring Boot Admin integrates seamlessly with Spring Cloud Discovery services, allowing automatic registration without](/4.0.0/docs/client/service-discovery.md)

## [<!-- -->Configuration](/4.0.0/docs/client/configuration.md)

[In addition to discovering and registering services, Spring Boot Admin makes use of metadata to control how individual](/4.0.0/docs/client/configuration.md)

## [<!-- -->Properties](/4.0.0/docs/client/properties.md)

[\<PropertyTable](/4.0.0/docs/client/properties.md)
