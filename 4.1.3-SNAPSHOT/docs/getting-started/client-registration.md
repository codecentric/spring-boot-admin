...
```
implementation 'de.codecentric:spring-boot-admin-starter-client:4.1.3-SNAPSHOT'
```
...
For more details, see [Security](/4.1.3-SNAPSHOT/docs/server/security.md).
...
* [Client Features](/4.1.3-SNAPSHOT/docs/client/client-features.md) - Learn about version display, JMX, logs, and tags
* [Client Configuration](/4.1.3-SNAPSHOT/docs/client/configuration.md) - Explore advanced client configuration
* [Service Discovery](/4.1.3-SNAPSHOT/docs/client/service-discovery.md) - Deep dive into Spring Cloud integration
