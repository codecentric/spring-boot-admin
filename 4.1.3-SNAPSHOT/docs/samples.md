...
* **[Servlet Sample](/4.1.3-SNAPSHOT/docs/samples/sample-servlet.md)** - Traditional servlet-based deployment with security
* **[Reactive Sample](/4.1.3-SNAPSHOT/docs/samples/sample-reactive.md)** - WebFlux reactive deployment

### Service Discovery[​](#service-discovery "Direct link to Service Discovery")

* **[Eureka Sample](/4.1.3-SNAPSHOT/docs/samples/sample-eureka.md)** - Netflix Eureka integration
* **[Consul Sample](/4.1.3-SNAPSHOT/docs/samples/sample-consul.md)** - HashiCorp Consul integration
* **[Zookeeper Sample](/4.1.3-SNAPSHOT/docs/samples/sample-zookeeper.md)** - Apache Zookeeper integration
...
* [Getting Started](/4.1.3-SNAPSHOT/docs/02-getting-started/) - Basic setup guide
* [Server Configuration](/4.1.3-SNAPSHOT/docs/server/server.md) - Server configuration options
* [Integration](/4.1.3-SNAPSHOT/docs/04-integration/) - Service discovery integration
* [Customization](/4.1.3-SNAPSHOT/docs/06-customization/) - UI and server customization
