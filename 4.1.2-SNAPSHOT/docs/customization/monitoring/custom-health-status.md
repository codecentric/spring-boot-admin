...
### StatusUpdater[​](#statusupdater "Direct link to StatusUpdater")
...
## StatusInfo[​](#statusinfo "Direct link to StatusInfo")

### Built-in Status Codes[​](#built-in-status-codes "Direct link to Built-in Status Codes")
...
### Creating StatusInfo[​](#creating-statusinfo "Direct link to Creating StatusInfo")
...
## Custom StatusUpdater[​](#custom-statusupdater "Direct link to Custom StatusUpdater")

### Example: Custom Timeout[​](#example-custom-timeout "Direct link to Example: Custom Timeout")
...
### Example: Custom Status Interpretation[​](#example-custom-status-interpretation "Direct link to Example: Custom Status Interpretation")
...
### Example: Custom Health Endpoint[​](#example-custom-health-endpoint "Direct link to Example: Custom Health Endpoint")
...
### Example: Combine Multiple Health Checks[​](#example-combine-multiple-health-checks "Direct link to Example: Combine Multiple Health Checks")
...
## Custom InfoUpdater[​](#custom-infoupdater "Direct link to Custom InfoUpdater")

### Default Behavior[​](#default-behavior-1 "Direct link to Default Behavior")
...
### Example: Custom Info Endpoint[​](#example-custom-info-endpoint "Direct link to Example: Custom Info Endpoint")
...
### Example: Enrich Info with Metadata[​](#example-enrich-info-with-metadata "Direct link to Example: Enrich Info with Metadata")
...
### Scenario 1: External Health Check[​](#scenario-1-external-health-check "Direct link to Scenario 1: External Health Check")
...
### Scenario 2: Synthetic Monitoring[​](#scenario-2-synthetic-monitoring "Direct link to Scenario 2: Synthetic Monitoring")
...
### Scenario 3: Database-Backed Status[​](#scenario-3-database-backed-status "Direct link to Scenario 3: Database-Backed Status")
...
### Monitor Status Updates[​](#monitor-status-updates "Direct link to Monitor Status Updates")
...
* [Server Configuration](/4.1.2-SNAPSHOT/docs/server/server.md)
* [Instance Filters](/4.1.2-SNAPSHOT/docs/customization/monitoring/instance-filters.md)
