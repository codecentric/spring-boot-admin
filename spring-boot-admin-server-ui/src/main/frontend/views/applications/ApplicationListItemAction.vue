...
import {ActionHandler, ApplicationActionHandler, InstanceActionHandler} from "@/views/applications/ActionHandler";
...
if (props.item instanceof Application) {
  actionHandler = new ApplicationActionHandler($sbaModal, t, notificationCenter);
  journalLink = {
    name: 'journal',
