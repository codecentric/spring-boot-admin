...
class UiControllerDiffblueTest {
	...
	/**
	 * Test ExternalView
	 * {@link ExternalView#ExternalView(String, String, Integer, boolean, List)}.
	 * <ul>
	...
	void testExternalViewNewExternalView_thenReturnChildrenIsArrayList() {
		...
		children.add(new ExternalView("'label' must not be empty", "https://example.org/example", 1, true,
				new ArrayList<>()));
	...
	void testExternalViewNewExternalView_thenReturnChildrenSizeIsTwo() {
		...
		children.add(new ExternalView("'label' must not be empty", "https://example.org/example", 1, true,
				new ArrayList<>()));
		ExternalView externalView = new ExternalView("'label' must not be empty", "https://example.org/example", 1,
				true, new ArrayList<>());
