...
For more details, see [Security](/4.0.1/docs/server/security.md).
...
* [Client Features](/4.0.1/docs/client/client-features.md) - Learn about version display, JMX, logs, and tags
* [Client Configuration](/4.0.1/docs/client/configuration.md) - Explore advanced client configuration
* [Service Discovery](/4.0.1/docs/client/service-discovery.md) - Deep dive into Spring Cloud integration
