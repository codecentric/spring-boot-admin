...
* Explore [Consul Sample](/4.1.0/docs/samples/sample-consul.md) for alternative service discovery
* Review [Zookeeper Sample](/4.1.0/docs/samples/sample-zookeeper.md) for Apache Zookeeper
* Check [Integration Guide](/4.1.0/docs/integration/eureka.md) for detailed Eureka setup
* See [Hazelcast Sample](/4.1.0/docs/samples/sample-hazelcast.md) for clustering

## See Also[​](#see-also "Direct link to See Also")

* [Eureka Integration Guide](/4.1.0/docs/integration/eureka.md)
* [Service Discovery](/4.1.0/docs/client/service-discovery.md)
