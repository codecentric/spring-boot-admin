...
* [Custom Health Status](/4.1.0/docs/customization/monitoring/custom-health-status.md)
* [Endpoint Detection](/4.1.0/docs/customization/server/endpoint-detection.md)
