...
* Explore [Reactive Sample](/4.0.4/docs/samples/sample-reactive.md) for WebFlux alternative
* Review [Security Documentation](/4.0.4/docs/05-security/) for deployment hardening
* Check [Customization Guide](/4.0.4/docs/06-customization/) for more extensions
* See [Notification Configuration](/4.0.4/docs/02-server/notifications/) for notifier options

## See Also[​](#see-also "Direct link to See Also")

* [Server Configuration](/4.0.4/docs/server/server.md)
* [Client Registration](/4.0.4/docs/client/registration.md)
* [UI Customization](/4.0.4/docs/06-customization/ui/)
* [Spring Security Integration](/4.0.4/docs/security/server-authentication.md)
