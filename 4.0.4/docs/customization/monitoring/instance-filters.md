...
* [Custom Health Status](/4.0.4/docs/customization/monitoring/custom-health-status.md)
* [Endpoint Detection](/4.0.4/docs/customization/server/endpoint-detection.md)
