...
* [Metadata](/4.0.4/docs/client/metadata.md) - Learn about custom metadata
* [Service Discovery](/4.0.4/docs/client/service-discovery.md) - Alternative registration using Spring Cloud Discovery
* [Client Configuration](/4.0.4/docs/client/configuration.md) - Complete configuration reference
* [Client Features](/4.0.4/docs/client/client-features.md) - Additional client capabilities
