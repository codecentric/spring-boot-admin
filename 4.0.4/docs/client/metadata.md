...
* [Client Features](/4.0.4/docs/client/client-features.md) - Other client capabilities
* [Registration](/4.0.4/docs/client/registration.md) - Application registration process
* [Service Discovery](/4.0.4/docs/client/service-discovery.md) - Metadata in service discovery
* [Security](/4.0.4/docs/server/security.md) - Securing metadata transmission
