...
* [Service Discovery](/4.0.4/docs/client/service-discovery.md) - Service discovery overview
* [Eureka Sample](/4.0.4/docs/samples/sample-eureka.md) - Detailed sample walkthrough
