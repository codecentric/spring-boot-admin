...
public class InstanceWebClientDiffblueTest {
   ...
   * <p>
   * Method under test: {@link InstanceWebClient.Builder#filter(InstanceExchangeFilterFunction)}
   */
  @Test
   ...
   * Test {@link InstanceWebClient#instance(Mono)} with {@code Mono}.
   * <ul>
   *   <li>Given {@link Builder} {@link Builder#filters(Consumer)} return {@link Builder}.</li>
   ...
   * Test {@link InstanceWebClient#instance(Mono)} with {@code Mono}.
   * <ul>
   *   <li>Given {@link InstanceWebClient.Builder} {@link InstanceWebClient.Builder#webClient(Builder)} return builder.</li>
