...
public class SanitizingMapSerializerDiffblueTest {
   ...
   * <p>
   * Method under test: {@link SanitizingMapSerializer#SanitizingMapSerializer(String[])}
   */
  @Test
   ...
   * <p>
   * Method under test: {@link SanitizingMapSerializer#serialize(Map, JsonGenerator, SerializerProvider)}
   */
  @Test
