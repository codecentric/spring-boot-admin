...
public class InstancesProxyControllerDiffblueTest {
	...
	/**
	 * Test {@link InstancesProxyController#endpointProxy(String, ServerHttpRequest)} with
	 * {@code applicationName}, {@code request}.
	 * <p>
	 * Method under test:
	...
	public void testEndpointProxyWithApplicationNameRequest() throws AssertionError {
		...
		// Act and Assert
		FirstStep<InstanceResponse> createResult = StepVerifier.create(
				instancesProxyController.endpointProxy("Application Name", new ServerHttpRequestDecorator(delegate)));
	...
	public void testEndpointProxyWithApplicationNameRequest_givenCreate() throws AssertionError {
		...
		// Act and Assert
		FirstStep<InstanceResponse> createResult2 = StepVerifier.create(
				instancesProxyController.endpointProxy("Application Name", new ServerHttpRequestDecorator(delegate)));
	 ...
	 * {@code applicationName}, {@code request}.
	 * <ul>
	 * <li>Given {@link HttpHeaders#HttpHeaders()} add {@code Header Name} and
	 * {@code 42}.</li>
	 * </ul>
	 * <p>
	 * Method under test:
