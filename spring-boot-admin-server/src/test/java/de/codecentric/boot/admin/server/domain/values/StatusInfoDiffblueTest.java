...
public class StatusInfoDiffblueTest {
	...
	/**
	 * Test {@link StatusInfo#valueOf(String, Map)} with {@code statusCode},
	 * {@code details}.
	 * <ul>
	 ...
	 * Test {@link StatusInfo#isOffline()}.
	 * <ul>
	 * <li>Given valueOf {@link StatusInfo#STATUS_OFFLINE} and
	 ...
	 * Test {@link StatusInfo#isDown()}.
	 * <ul>
	 * <li>Given valueOf {@link StatusInfo#STATUS_DOWN} and
	 * {@link HashMap#HashMap()}.</li>
	 * <li>Then return {@code true}.</li>
	 * </ul>
	 * <p>
	 ...
	 * Test {@link StatusInfo#isUnknown()}.
	 * <ul>
	 * <li>Given valueOf {@link StatusInfo#STATUS_UNKNOWN} and
	 * {@link HashMap#HashMap()}.</li>
	 * <li>Then return {@code true}.</li>
	 * </ul>
	 * <p>
