...
public class ApplicationRegistryDiffblueTest {
   ...
   * <p>
   * Method under test: {@link ApplicationRegistry#ApplicationRegistry(InstanceRegistry, InstanceEventPublisher)}
   */
  @Test
  ...
  public void testGetApplications_givenFluxFlatMapReturnFlux_thenCallsFlatMap() throws AssertionError {
    ...
    FirstStep<Application> createResult = StepVerifier
        .create(new ApplicationRegistry(new InstanceRegistry(new EventsourcingInstanceRepository(eventStore),
            mock(InstanceIdGenerator.class), mock(InstanceFilter.class)), mock(InstanceEventPublisher.class))
            .getApplications());
    createResult.expectComplete().verify();
   ...
   */
  @Test
  public void testGetApplications_givenFluxFlatMapReturnFromIterableArrayList_thenCallsFlatMap() throws AssertionError {
    // Arrange
   ...
   */
  @Test
  public void testGetApplications_givenFluxGroupByReturnFromIterableArrayList_thenCallsFilter() throws AssertionError {
    // Arrange
    Flux<Instance> flux = mock(Flux.class);
   ...
   */
  @Test
  public void testGetApplications_givenFluxGroupByReturnFromIterableArrayList_thenCallsFindAll() throws AssertionError {
    // Arrange
   ...
   */
  @Test
  public void testGetApplications_givenInstanceRegistryGetInstancesReturnFromIterableArrayList() throws AssertionError {
    // Arrange
    Flux<Instance> fromIterableResult = Flux.fromIterable(new ArrayList<>());
   ...
   */
  @Test
  public void testGetApplication_givenFluxFlatMapReturnFromIterableArrayList_thenCallsFlatMap() throws AssertionError {
    // Arrange
    Flux<GroupedFlux<Object, InstanceEvent>> flux = mock(Flux.class);
    Flux<Object> fromIterableResult = Flux.fromIterable(new ArrayList<>());
    when(flux.flatMap(Mockito.<Function<GroupedFlux<Object, InstanceEvent>, Publisher<Object>>>any()))
   ...
   *   <li>When {@link Flux} {@link Flux#collectList()} return just {@link ArrayList#ArrayList()}.</li>
   * </ul>
   * <p>
   ...
   * <ul>
   *   <li>When {@link LocalDate} with {@code 1970} and one and one atStartOfDay atZone {@link ZoneOffset#UTC} toInstant.</li>
   * </ul>
   * <p>
   ...
   * Test {@link ApplicationRegistry#getMax(Instant, Instant)}.
   * <ul>
   *   <li>When ofYearDay one and one atStartOfDay atZone {@link ZoneOffset#UTC} toInstant.</li>
   * </ul>
   * <p>
   * Method under test: {@link ApplicationRegistry#getMax(Instant, Instant)}
   */
