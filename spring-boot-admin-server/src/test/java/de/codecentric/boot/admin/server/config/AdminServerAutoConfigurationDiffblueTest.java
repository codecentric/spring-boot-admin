...
public class AdminServerAutoConfigurationDiffblueTest {
	...
	public void testInstanceRegistry() throws AssertionError {
		...
		FirstStep<Instance> createResult = StepVerifier.create(adminServerAutoConfiguration
	...
	/**
	 * Test
	 * {@link AdminServerAutoConfiguration#statusUpdater(InstanceRepository, Builder)}.
	 * <ul>
	...
	public void testStatusUpdater_givenBuilderBuildReturnWebClient_thenCallsBuild() {
		// Arrange
		EventsourcingInstanceRepository instanceRepository = new EventsourcingInstanceRepository(
	...
	/**
	 * Test
	 * {@link AdminServerAutoConfiguration#statusUpdateTrigger(StatusUpdater, Publisher)}.
	 * <p>
	 * Method under test:
	 * {@link AdminServerAutoConfiguration#statusUpdateTrigger(StatusUpdater, Publisher)}
	 */
	...
	/**
	 * Test
	 * {@link AdminServerAutoConfiguration#endpointDetector(InstanceRepository, Builder)}.
	 * <ul>
	 * <li>Given {@link Builder} {@link Builder#build()} return {@link WebClient}.</li>
	 * <li>Then calls {@link InstanceWebClient.Builder#build()}.</li>
	 * </ul>
	...
	/**
	 * Test
	 * {@link AdminServerAutoConfiguration#endpointDetectionTrigger(EndpointDetector, Publisher)}.
	 * <ul>
	...
	/**
	 * Test
	 * {@link AdminServerAutoConfiguration#infoUpdateTrigger(InfoUpdater, Publisher)}.
	 * <p>
	 * Method under test:
	 * {@link AdminServerAutoConfiguration#infoUpdateTrigger(InfoUpdater, Publisher)}
	 */
	...
	public void testEventStore() throws AssertionError {
		...
		FirstStep<InstanceEvent> createResult = StepVerifier
			.create(adminServerAutoConfiguration.eventStore().findAll());
		createResult.expectComplete().verify();
	}
