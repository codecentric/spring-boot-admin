...
public class RedisNotificationTriggerTest {
	...
	private final RedisNotificationTrigger trigger = new RedisNotificationTrigger(this.notifier, this.events,
			this.sentNotifications);

	@Test
	public void should_trigger_notifications() {
	...
	@Test
	public void should_not_trigger_notifications() {
