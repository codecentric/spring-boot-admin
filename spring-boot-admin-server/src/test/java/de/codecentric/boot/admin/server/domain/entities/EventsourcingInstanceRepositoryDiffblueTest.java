...
public class EventsourcingInstanceRepositoryDiffblueTest {
	 ...
	 */
	@Test
	public void testSave_givenEventsourcingInstanceRepositoryWithEventStoreIsInMemoryEventStore()
	 ...
	 */
	@Test
	public void testFind_givenEventsourcingInstanceRepositoryWithEventStoreIsInMemoryEventStore()
			throws AssertionError {
		// Arrange
		EventsourcingInstanceRepository eventsourcingInstanceRepository = new EventsourcingInstanceRepository(
				new InMemoryEventStore());
