...
public class ApplicationNameNotificationFilterDiffblueTest {
  /**
   * Test {@link ApplicationNameNotificationFilter#ApplicationNameNotificationFilter(String, Instant)}.
   * <p>
   * Method under test: {@link ApplicationNameNotificationFilter#ApplicationNameNotificationFilter(String, Instant)}
   */
  @Test
