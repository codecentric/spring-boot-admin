...
public class OptimisticLockingExceptionDiffblueTest {
	 ...
	 * <p>
	 * Method under test:
	 * {@link OptimisticLockingException#OptimisticLockingException(String)}
	 */
	@Test
	public void testNewOptimisticLockingException() {
		// Arrange and Act
		OptimisticLockingException actualOptimisticLockingException = new OptimisticLockingException(
				"An error occurred");
