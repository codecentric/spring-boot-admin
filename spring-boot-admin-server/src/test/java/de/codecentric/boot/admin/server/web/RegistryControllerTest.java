...
public class RegistryControllerTest {
    ...
    public void setup() {
        ...
        EventSourcingApplicationRepository repository = new EventSourcingApplicationRepository(eventStore);
        repository.start();
        ApplicationRegistry registry = new ApplicationRegistry(repository, new HashingApplicationUrlIdGenerator());
        mvc = MockMvcBuilders.standaloneSetup(new RegistryController(registry, eventStore)).build();
    }
    ...
    public void test_register_twice_get_and_remove() throws Exception {
        ...
        MvcResult eventResult = mvc.perform(get("/api/applications/events"))
