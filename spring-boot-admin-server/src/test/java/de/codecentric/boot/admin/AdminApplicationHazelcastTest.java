...
public class AdminApplicationHazelcastTest {
	...
	public void setup() throws InterruptedException {
		...
		instance1 = (ServletWebServerApplicationContext) SpringApplication
				.run(TestAdminApplication.class, "--server.port=0", "--spring.jmx.enabled=false");
		instance2 = (ServletWebServerApplicationContext) SpringApplication
				.run(TestAdminApplication.class, "--server.port=0", "--spring.jmx.enabled=false");
	}
	...
	public void test() throws Exception {
		...
		assertThat(apps).extracting("id").containsExactly(app.get("id"), app2.get("id"))
