...
import static de.codecentric.boot.admin.notify.microsoft.teams.MicrosoftTeamsNotifier.DEREGISTER_ACTIVITY_SUBTITLE_PATTERN;
import static de.codecentric.boot.admin.notify.microsoft.teams.MicrosoftTeamsNotifier.DE_REGISTERED_TITLE;
import static de.codecentric.boot.admin.notify.microsoft.teams.MicrosoftTeamsNotifier.HEALTH_URL_KEY;
import static de.codecentric.boot.admin.notify.microsoft.teams.MicrosoftTeamsNotifier.MANAGEMENT_URL_KEY;
import static de.codecentric.boot.admin.notify.microsoft.teams.MicrosoftTeamsNotifier.MESSAGE_SUMMARY;
import static de.codecentric.boot.admin.notify.microsoft.teams.MicrosoftTeamsNotifier.REGISTERED_TITLE;
import static de.codecentric.boot.admin.notify.microsoft.teams.MicrosoftTeamsNotifier.REGISTER_ACTIVITY_SUBTITLE_PATTERN;
import static de.codecentric.boot.admin.notify.microsoft.teams.MicrosoftTeamsNotifier.SERVICE_URL_KEY;
import static de.codecentric.boot.admin.notify.microsoft.teams.MicrosoftTeamsNotifier.SOURCE_KEY;
import static de.codecentric.boot.admin.notify.microsoft.teams.MicrosoftTeamsNotifier.STATUS_ACTIVITY_SUBTITLE_PATTERN;
import static de.codecentric.boot.admin.notify.microsoft.teams.MicrosoftTeamsNotifier.STATUS_CHANGED_TITLE;
import static de.codecentric.boot.admin.notify.microsoft.teams.MicrosoftTeamsNotifier.STATUS_KEY;
