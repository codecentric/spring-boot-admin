...
public class AbstractStatusChangeNotifierDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link AbstractStatusChangeNotifier#shouldNotify(InstanceEvent, Instance)}
   */
  @Test
  public void testShouldNotify_whenNull_thenReturnFalse() {
    // Arrange, Act and Assert
    assertFalse(
        new LoggingNotifier(new EventsourcingInstanceRepository(new InMemoryEventStore())).shouldNotify(null, null));
  }
