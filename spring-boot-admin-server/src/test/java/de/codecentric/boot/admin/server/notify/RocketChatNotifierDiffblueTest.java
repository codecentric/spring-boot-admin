...
public class RocketChatNotifierDiffblueTest {
	...
	public void testNewRocketChatNotifier() throws EvaluationException {
		// Arrange and Act
		RocketChatNotifier actualRocketChatNotifier = new RocketChatNotifier(instanceRepository,
	...
	public void testDoNotify_whenInstanceIdWithValueIs42Value() throws AssertionError {
		// Arrange, Act and Assert
		FirstStep<Void> createResult = StepVerifier.create(rocketChatNotifier
			.doNotify(new InstanceDeregisteredEvent(InstanceId.of("42Value"), Long.MAX_VALUE), null));
		createResult.expectError().verify();
	}
	 ...
	 * <ul>
	 * <li>Given {@link IMap} {@link IMap#addEntryListener(MapListener, boolean)} return
	 * randomUUID.</li>
	 ...
	 * Test {@link RocketChatNotifier#getText(InstanceEvent, Instance)}.
	 * <ul>
	 * <li>Given {@link InMemoryEventStore#InMemoryEventStore(int)} with
	 * maxLogSizePerAggregate is three.</li>
	 * </ul>
	 * <p>
	 * Method under test: {@link RocketChatNotifier#getText(InstanceEvent, Instance)}
	 */
	 ...
	 * <ul>
	 * <li>When
	 * {@link InstanceDeregisteredEvent#InstanceDeregisteredEvent(InstanceId, long)} with
	 * instance is {@link InstanceId} and version is one.</li>
	 * </ul>
	 * <p>
	 * Method under test: {@link RocketChatNotifier#getText(InstanceEvent, Instance)}
	 */
	 ...
	 * <li>When
	 * {@link InstanceDeregisteredEvent#InstanceDeregisteredEvent(InstanceId, long)} with
	 * instance is {@link InstanceId} and version is two.</li>
	 * </ul>
	 * <p>
	 * Method under test: {@link RocketChatNotifier#getText(InstanceEvent, Instance)}
	 */
