...
public class DiscordNotifierDiffblueTest {
   ...
   * <p>
   * Method under test: {@link DiscordNotifier#DiscordNotifier(InstanceRepository, RestTemplate)}
   */
  @Test
   ...
   * <ul>
   *   <li>Given {@link DiscordNotifier} WebhookUrl is {@link PagerdutyNotifier#DEFAULT_URI}.</li>
   * </ul>
   * <p>
   ...
   * <ul>
   *   <li>Then return Body {@code avatar_url} is {@code https://example.org/example}.</li>
   * </ul>
   * <p>
   * Method under test: {@link DiscordNotifier#createDiscordNotification(InstanceEvent, Instance)}
   */
  @Test
