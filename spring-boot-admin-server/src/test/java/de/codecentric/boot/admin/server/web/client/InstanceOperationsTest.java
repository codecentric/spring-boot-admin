...
public class InstanceOperationsTest {
    ...
    private InstanceOperations ops = new InstanceOperations(webClient, headersProvider);
    ...
    public void test_getInfo() {
        ...
        when(headersProvider.getHeaders(eq(instance))).thenReturn(headers);

        StepVerifier.create(ops.getInfo(instance)).verifyComplete();
    ...
    public void test_getHealth() {
        ...
        StepVerifier.create(ops.getHealth(instance)).verifyComplete();
