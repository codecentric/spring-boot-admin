...
public class EventSourcingInstanceRepositoryTest {
    private EventSourcingInstanceRepository repository = new EventSourcingInstanceRepository(new InMemoryEventStore());
