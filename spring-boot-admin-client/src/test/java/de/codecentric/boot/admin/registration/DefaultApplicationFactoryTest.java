...
public class DefaultApplicationFactoryTest {
    ...
    private DefaultApplicationFactory factory = new DefaultApplicationFactory(client, management, server,
    ...
    public void test_mgmtPortPath() {
        ...
        DefaultApplicationFactory factory = new DefaultApplicationFactory(client, management, server, servletContext,
                "/alive");
    ...
    public void test_all_baseUrls() {
        client.setManagementBaseUrl("http://management:8090");
        client.setServiceBaseUrl("http://service:80");
        servletContext.setContextPath("/srv");
        management.setContextPath("/admin");

        Application app = factory.createApplication();
        assertThat(app.getServiceUrl(), is("http://service:80/srv/"));
        assertThat(app.getManagementUrl(), is("http://management:8090/admin/"));
        assertThat(app.getHealthUrl(), is("http://management:8090/admin/health/"));
    }
    ...
    public void test_service_baseUrl() {
        ...
        Application app = factory.createApplication();
        assertThat(app.getServiceUrl(), is("http://service:80/srv/"));
        assertThat(app.getManagementUrl(), is("http://service:80/srv/app/admin/"));
        assertThat(app.getHealthUrl(), is("http://service:80/srv/app/admin/health/"));
    }
    ...
    public void test_missingports() {
        try {
            ...
            assertThat(ex.getMessage(), containsString("service-base-url"));
        }
