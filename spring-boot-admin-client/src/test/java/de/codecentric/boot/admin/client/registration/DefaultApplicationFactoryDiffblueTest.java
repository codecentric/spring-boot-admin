...
class DefaultApplicationFactoryDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link WebEndpointProperties} (default constructor) BasePath is empty string.</li>
   ...
   * <ul>
   *   <li>Given {@link InstanceProperties} (default constructor) PreferIp is {@code false}.</li>
   * </ul>
   * <p>
   ...
   * <ul>
   *   <li>Given {@link InstanceProperties} (default constructor) ManagementBaseUrl is {@code null}.</li>
   * </ul>
   * <p>
   ...
   * <ul>
   *   <li>Given {@link InstanceProperties} (default constructor) ManagementBaseUrl is empty string.</li>
   * </ul>
   * <p>
  ...
  void testGetMetadata_givenMetadataContributorGetMetadataReturnHashMap_thenReturnEmpty() {
    ...
    Map<String, String> actualMetadata = new DefaultApplicationFactory(instance, management, server,
        new PathMappedEndpoints("Base Path", new ArrayList<>()), webEndpoint, metadataContributor).getMetadata();
