...
[A quick guide](http://codecentric.github.io/spring-boot-admin/1.5.1/#getting-started) to get started can be found in our docs.

## Getting Help

Having trouble with Spring Boot Admin? We’d like to help!

 * Check the [reference documentation](http://codecentric.github.io/spring-boot-admin/1.5.1/).
...
## Reference Guide
[Version 1.5.1](http://codecentric.github.io/spring-boot-admin/1.5.1/)
