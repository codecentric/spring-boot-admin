...
### [Event Types](/4.1.0-SNAPSHOT/docs/reference/event-types.md)[​](#event-types "Direct link to event-types")
...
### [REST API](/4.1.0-SNAPSHOT/docs/reference/rest-api.md)[​](#rest-api "Direct link to rest-api")
...
* [Client Configuration](/4.1.0-SNAPSHOT/docs/client/registration.md)
* [Customization](/4.1.0-SNAPSHOT/docs/06-customization/)
* [Notifications](/4.1.0-SNAPSHOT/docs/02-server/notifications/)
