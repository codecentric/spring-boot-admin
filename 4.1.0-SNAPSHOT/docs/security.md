...
**See**: [Server Authentication](/4.1.0-SNAPSHOT/docs/security/server-authentication.md)
...
**See**: [Actuator Security](/4.1.0-SNAPSHOT/docs/security/actuator-security.md)
...
**See**: [CSRF Protection](/4.1.0-SNAPSHOT/docs/security/csrf-protection.md)
...
* [Server Authentication](/4.1.0-SNAPSHOT/docs/security/server-authentication.md) - Secure Admin Server with Spring Security
* [Actuator Security](/4.1.0-SNAPSHOT/docs/security/actuator-security.md) - Secure client actuator endpoints
* [CSRF Protection](/4.1.0-SNAPSHOT/docs/security/csrf-protection.md) - Configure CSRF for UI and API
...
* [Client Configuration](/4.1.0-SNAPSHOT/docs/client/client-features.md)
