...
* [Client Features](/4.1.0-SNAPSHOT/docs/client/client-features.md) - Other client capabilities
* [Registration](/4.1.0-SNAPSHOT/docs/client/registration.md) - Application registration process
* [Service Discovery](/4.1.0-SNAPSHOT/docs/client/service-discovery.md) - Metadata in service discovery
* [Security](/4.1.0-SNAPSHOT/docs/server/security.md) - Securing metadata transmission
