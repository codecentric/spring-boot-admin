...
* Explore [Servlet Sample](/4.1.1/docs/samples/sample-servlet.md) for traditional deployment
* Review [Eureka Sample](/4.1.1/docs/samples/sample-eureka.md) for service discovery
* Check [Hazelcast Sample](/4.1.1/docs/samples/sample-hazelcast.md) for clustering
* Read [Customization Guide](/4.1.1/docs/06-customization/) for extensions
