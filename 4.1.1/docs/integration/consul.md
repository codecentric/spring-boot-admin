...
* [Service Discovery](/4.1.1/docs/client/service-discovery.md) - Service discovery overview
* [Consul Sample](/4.1.1/docs/samples/sample-consul.md) - Detailed sample walkthrough
