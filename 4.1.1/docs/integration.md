...
* **[Eureka](/4.1.1/docs/integration/eureka.md)** - Netflix Eureka service discovery
* **[Consul](/4.1.1/docs/integration/consul.md)** - HashiCorp Consul service mesh
* **[Zookeeper](/4.1.1/docs/integration/zookeeper.md)** - Apache Zookeeper coordination service
...
* **[Hazelcast](/4.1.1/docs/integration/hazelcast.md)** - Distributed event store and coordination
...
* [Service Discovery](/4.1.1/docs/client/service-discovery.md) - Client-side discovery configuration
* [Clustering](/4.1.1/docs/server/Clustering.md) - Admin Server clustering details
* [Samples](/4.1.1/docs/09-samples/) - Working example projects
