...
* [Metadata](/4.0.0-SNAPSHOT/docs/client/metadata.md) - Learn about custom metadata
* [Service Discovery](/4.0.0-SNAPSHOT/docs/client/service-discovery.md) - Alternative registration using Spring Cloud Discovery
* [Client Configuration](/4.0.0-SNAPSHOT/docs/client/configuration.md) - Complete configuration reference
* [Client Features](/4.0.0-SNAPSHOT/docs/client/client-features.md) - Additional client capabilities
