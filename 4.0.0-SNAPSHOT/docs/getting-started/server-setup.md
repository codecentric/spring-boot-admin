...
```
dependencies {
    implementation 'de.codecentric:spring-boot-admin-starter-server:4.0.0-SNAPSHOT'
...
* [Client Registration](/4.0.0-SNAPSHOT/docs/getting-started/client-registration.md) - Learn how to register applications with the server
* [Server Configuration](/4.0.0-SNAPSHOT/docs/server/server.md) - Explore advanced server configuration options
* [Security](/4.0.0-SNAPSHOT/docs/server/security.md) - Secure your Admin Server
