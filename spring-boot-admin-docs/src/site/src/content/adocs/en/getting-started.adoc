...
----
<1> For the sake of brevity we're disabling the security for now. Have a look at the <<server/security#securing-spring-boot-admin,security section>> on how to deal with secured endpoints.
