...
----
If your Spring Boot Admin Server uses a Spring Boot milestone or snapshot version you need to include
one or both of the following repositories to be able to resolve the Spring artifact:
+
[source,xml]
.pom.xml
----
