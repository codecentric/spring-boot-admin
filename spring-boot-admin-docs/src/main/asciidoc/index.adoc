...
[slack-notifications]
==== Slack notifications ====
To enable Slack notifications you need to add configuration in Incoming WebHooks in Custom Integrations on your Slack
account and set the appropriate configuration properties.
...
| The Slack WebHooks URL to send notifications
|
