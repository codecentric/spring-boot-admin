...
| spring.boot.admin.ui.custom-label
|  A custom label to be displayed inside the header.
|

| spring.boot.admin.ui.custom-image-src
|  A custom image source value to be displayed beside the optional custom label.
|
