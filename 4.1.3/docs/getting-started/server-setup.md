...
dependencies {
    ...
    implementation 'de.codecentric:spring-boot-admin-starter-server:4.1.3'
...
* [Client Registration](/4.1.3/docs/getting-started/client-registration.md) - Learn how to register applications with the server
* [Server Configuration](/4.1.3/docs/server/server.md) - Explore advanced server configuration options
* [Security](/4.1.3/docs/server/security.md) - Secure your Admin Server
