...
```
implementation 'de.codecentric:spring-boot-admin-starter-client:4.1.3'
```
...
For more details, see [Security](/4.1.3/docs/server/security.md).
...
* [Client Features](/4.1.3/docs/client/client-features.md) - Learn about version display, JMX, logs, and tags
* [Client Configuration](/4.1.3/docs/client/configuration.md) - Explore advanced client configuration
* [Service Discovery](/4.1.3/docs/client/service-discovery.md) - Deep dive into Spring Cloud integration
