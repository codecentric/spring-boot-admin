...
**See**: [Server Authentication](/4.1.3/docs/security/server-authentication.md)
...
**See**: [Actuator Security](/4.1.3/docs/security/actuator-security.md)
...
**See**: [CSRF Protection](/4.1.3/docs/security/csrf-protection.md)
...
**See**: [SSRF Protection](/4.1.3/docs/security/ssrf-protection.md)
...
* [Server Authentication](/4.1.3/docs/security/server-authentication.md) - Secure Admin Server with Spring Security
* [Actuator Security](/4.1.3/docs/security/actuator-security.md) - Secure client actuator endpoints
* [CSRF Protection](/4.1.3/docs/security/csrf-protection.md) - Configure CSRF for UI and API
* [SSRF Protection](/4.1.3/docs/security/ssrf-protection.md) - Block SSRF attacks via instance registration
...
* [Client Configuration](/4.1.3/docs/client/client-features.md)
