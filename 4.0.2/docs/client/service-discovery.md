...
* [Registration](/4.0.2/docs/client/registration.md) - Direct client registration
* [Metadata](/4.0.2/docs/client/metadata.md) - Working with metadata
* [Eureka Sample](/4.0.2/docs/samples/sample-eureka.md) - Complete Eureka example
* [Consul Sample](/4.0.2/docs/samples/sample-consul.md) - Complete Consul example
* [Security](/4.0.2/docs/server/security.md) - Securing discovered services
