...
## Securing Client Actuator Endpoints[​](#securing-client-actuator-endpoints "Direct link to Securing Client Actuator Endpoints")
...
### SBA Client[​](#sba-client "Direct link to SBA Client")
...
### SBA Server[​](#sba-server "Direct link to SBA Server")
...
## CSRF on Actuator Endpoints[​](#csrf-on-actuator-endpoints "Direct link to CSRF on Actuator Endpoints")
