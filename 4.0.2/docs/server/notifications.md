...
![Sample notification filters](/4.0.2/assets/images/notification-filter-afa48c90c2d49abec2c974d5d4387a9c.png)
...
## [<!-- -->Creating Custom Notifiers](/4.0.2/docs/server/notifications/custom-notifiers.md)

[Spring Boot Admin makes it easy to create custom notifiers to integrate with your preferred notification channels. You](/4.0.2/docs/server/notifications/custom-notifiers.md)

## [<!-- -->DingTalk Notifications](/4.0.2/docs/server/notifications/notifier-dingtalk.md)

[To enable DingTalk notifications you need to create and authorize a dingtalk bot and set the appropriate configuration properties for webhookUrl and secret.](/4.0.2/docs/server/notifications/notifier-dingtalk.md)

## [<!-- -->Discord Notifications](/4.0.2/docs/server/notifications/notifier-discord.md)

[To enable Discord notifications you need to create a webhook and set the appropriate configuration property.](/4.0.2/docs/server/notifications/notifier-discord.md)

## [<!-- -->Hipchat Notifications](/4.0.2/docs/server/notifications/notifier-hipchat.md)

[To enable Hipchat notifications you need to create an API token on your Hipchat account and set the appropriate configuration properties.](/4.0.2/docs/server/notifications/notifier-hipchat.md)

## [<!-- -->Let’s Chat Notifications](/4.0.2/docs/server/notifications/notifier-lets-chat.md)

[To enable Let’s Chat notifications you need to add the host url and add the API token and username from Let’s Chat](/4.0.2/docs/server/notifications/notifier-lets-chat.md)

## [<!-- -->Mail Notifications](/4.0.2/docs/server/notifications/notifier-mail.md)

[Mail notifications will be delivered as HTML emails rendered using https://www.thymeleaf.org/\[Thymeleaf\] templates.](/4.0.2/docs/server/notifications/notifier-mail.md)

## [<!-- -->Mattermost Notifications](/4.0.2/docs/server/notifications/notifier-mattermost.md)

[To enable Mattermost notifications you need to add a bot account under integrations on your Mattermost server and configure it appropriately.](/4.0.2/docs/server/notifications/notifier-mattermost.md)

## [<!-- -->Microsoft Teams Notifications](/4.0.2/docs/server/notifications/notifier-msteams.md)

[To enable Microsoft Teams notifications you need to set up a connector webhook url and set the appropriate configuration property.](/4.0.2/docs/server/notifications/notifier-msteams.md)

## [<!-- -->RocketChat Notifications](/4.0.2/docs/server/notifications/notifier-rocketchat.md)

[To enable Rocket.Chat notifications you need a personal token access and create a room to send message with this token](/4.0.2/docs/server/notifications/notifier-rocketchat.md)

## [<!-- -->Slack Notifications](/4.0.2/docs/server/notifications/notifier-slack.md)

[To enable Slack notifications you need to add an incoming Webhook under custom integrations on your Slack account and configure it appropriately.](/4.0.2/docs/server/notifications/notifier-slack.md)

## [<!-- -->Telegram Notifications](/4.0.2/docs/server/notifications/notifier-telegram.md)

[To enable Telegram notifications you need to create and authorize a telegram bot and set the appropriate configuration properties for auth-token and chat-id.](/4.0.2/docs/server/notifications/notifier-telegram.md)

## [<!-- -->Webex Notifications](/4.0.2/docs/server/notifications/notifier-webex.md)

[To enable Webex notifications, you need to set the appropriate configuration properties for auth-token and room-id.](/4.0.2/docs/server/notifications/notifier-webex.md)
