...
**See**: [Server Authentication](/4.0.2/docs/security/server-authentication.md)
...
**See**: [Actuator Security](/4.0.2/docs/security/actuator-security.md)
...
**See**: [CSRF Protection](/4.0.2/docs/security/csrf-protection.md)
...
* [Server Authentication](/4.0.2/docs/security/server-authentication.md) - Secure Admin Server with Spring Security
* [Actuator Security](/4.0.2/docs/security/actuator-security.md) - Secure client actuator endpoints
* [CSRF Protection](/4.0.2/docs/security/csrf-protection.md) - Configure CSRF for UI and API
...
* [Client Configuration](/4.0.2/docs/client/client-features.md)
