...
* Explore [Eureka Sample](/4.0.2/docs/samples/sample-eureka.md) for Netflix Eureka
* Review [Zookeeper Sample](/4.0.2/docs/samples/sample-zookeeper.md) for Apache Zookeeper
* Check [Consul Integration Guide](/4.0.2/docs/integration/consul.md) for detailed setup
* See [Hazelcast Sample](/4.0.2/docs/samples/sample-hazelcast.md) for clustering

## See Also[​](#see-also "Direct link to See Also")

* [Consul Integration Guide](/4.0.2/docs/integration/consul.md)
