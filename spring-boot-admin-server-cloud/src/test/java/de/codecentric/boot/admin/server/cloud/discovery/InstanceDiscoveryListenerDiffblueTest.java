...
class InstanceDiscoveryListenerDiffblueTest {
	 ...
	 * {@link DefaultServiceInstance#DefaultServiceInstance()}.</li>
	 ...
	 * Test {@link InstanceDiscoveryListener#onApplicationReady(ApplicationReadyEvent)}.
	 * <ul>
	 * <li>Given {@link InMemoryEventStore} {@link ConcurrentMapEventStore#findAll()}
	 * return create three and {@code true}.</li>
	 * </ul>
	 * <p>
	 * Method under test:
	 * {@link InstanceDiscoveryListener#onApplicationReady(ApplicationReadyEvent)}
	 ...
	 * Test {@link InstanceDiscoveryListener#onApplicationReady(ApplicationReadyEvent)}.
	 * <ul>
	 * <li>Given {@link InstanceRegistry} {@link InstanceRegistry#register(Registration)}
	 * return {@code null}.</li>
	...
	void testRegisterInstance() throws AssertionError {
		...
		FirstStep<InstanceId> createResult = StepVerifier.create(instanceDiscoveryListener
			.registerInstance(new DefaultServiceInstance("42", "", "localhost", 8080, true)));
	 ...
	 * with eventStore is {@code null}.</li>
	 * </ul>
	 * <p>
	 * Method under test:
	 * {@link InstanceDiscoveryListener#registerInstance(ServiceInstance)}
	 ...
	 * Test {@link InstanceDiscoveryListener#registerInstance(ServiceInstance)}.
	 * <ul>
	 * <li>Given {@link InstanceIdGenerator}
	 * {@link InstanceIdGenerator#generateId(Registration)} return {@code null}.</li>
	 * </ul>
	 * <p>
	 * Method under test:
	 * {@link InstanceDiscoveryListener#registerInstance(ServiceInstance)}
	 ...
	 * {@link InstanceRepository#compute(InstanceId, BiFunction)} return
	 * {@code null}.</li>
	...
	void testRegisterInstance_givenInstanceRepositoryComputeReturnNull_thenCallsCompute() throws AssertionError {
		...
		when(repository.compute(Mockito.<InstanceId>any(),
	...
	/**
	 * Test {@link InstanceDiscoveryListener#toString(ServiceInstance)} with
	...
	void testToStringWithServiceInstance3() {
		...
		// Act and Assert
		assertEquals("serviceId=42, instanceId=42, url= https://localhost:8080",
				instanceDiscoveryListener.toString(new DefaultKubernetesServiceInstance("42", "42", "localhost", 8080,
						metadata, true, "https", "https", new HashMap<>())));
	}
